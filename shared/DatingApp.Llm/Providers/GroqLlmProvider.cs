...
/// <summary>
/// Groq provider — fallback (FREE tier: OpenAI-compatible API).
/// </summary>
public class GroqLlmProvider : ILlmProvider
{
    ...
    public GroqLlmProvider(HttpClient http, IOptions<LlmOptions> options, ILogger<GroqLlmProvider> logger)
    {
        _http = http;
        _logger = logger;
