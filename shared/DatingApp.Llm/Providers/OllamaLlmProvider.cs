...
/// <summary>
/// Ollama provider — dev/local (unlimited, no network dependency).
/// </summary>
public class OllamaLlmProvider : ILlmProvider
{
    ...
    public OllamaLlmProvider(HttpClient http, IOptions<LlmOptions> options, ILogger<OllamaLlmProvider> logger)
    {
        _http = http;
        _logger = logger;
