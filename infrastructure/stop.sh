...
SERVICES=(keycloak keycloak-db UserService-db MatchmakingService-db swipe-service-db photo-service-db messaging-service-db reputation-db forum-db video-service-db)
